...
#ifndef _CIRCLE_SYSDEP_H_
#define _CIRCLE_SYSDEP_H_
...
#if defined(_CIRCLE_COMM_C_) || defined(CIRCLE_UNIX)
...
#endif /* _CIRCLE_COMM_C_ || CIRCLE_UNIX */


/* Header files that are only used in act.other.c */
#ifdef _CIRCLE_ACT_OTHER_C_

#ifdef HAVE_SYS_STAT_H
# include <sys/stat.h>
#endif

#endif /* _CIRCLE_ACT_OTHER_C_ */
