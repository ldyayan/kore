...
/* HACKED to not check class either, bleh! */
/*
...
/* HACKED to not check race either, that sucks */
/*
...
{
/* HACK keep shops always open */
/* but give the message anyway... :) */
  char buf[200];
  ...
  *buf = 0;
  ...
  switch (number(0,4)) {
    case 0:
      do_say(keeper, "Oh, come in...\r\n", cmd_tell, 0);
      break;
    case 1:
      do_say(keeper, "I guess just this one time...\r\n", cmd_tell, 0);
      break;
    case 2:
      do_say(keeper, "Next time, I might not be so nice!\r\n", cmd_tell, 0);
      break;
    case 3:
      do_say(keeper, "You are a pain, but come on in.. *sigh*\r\n",
        cmd_tell, 0);
      break;
    case 4:
      do_say(keeper, "Oh all right, I'll sell to you anyways.  Sheesh.\r\n",
        cmd_tell, 0);
      break;
    case 5:
      do_say(keeper, "I wish people would read the hours, grumble.\r\n",
        cmd_tell, 0);
      break;
    default:
      break;
...
/*  cmd_slap = find_command("slap");
  ...
  cmd_slap = find_social("slap");
  cmd_puke = find_social("puke");
  for (index = 0; index < top_shop; index++) {
