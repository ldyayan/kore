...
/* we save it large, and read it in to be 1 smaller,
  this way the default goes from zone 0 (no no!) to -1 (yes)
  so by default they cant edit any zones, WHEW */
...
#define OEDIT_PERMAFF			26
#define OEDIT_PERMAFF2			27
#define OEDIT_PROMPT_WEAPON_SPELL	28
#define OEDIT_WEAPON_SPELL		29
#define OEDIT_WEAPON_SPELL_LVL		30
#define OEDIT_WEAPON_SPELL_PRCNT	31
